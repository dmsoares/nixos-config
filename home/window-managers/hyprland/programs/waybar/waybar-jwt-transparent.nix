  ...
  programs.waybar = {
    ...
    settings = [{
      ...
      "custom/menu" = {
        format = "  ";
        on-click = ''
          pkill rofi || rofi -show combi -modes combi -combi-modes "window,drun" -show-icons'';
      ...
      "custom/cava_mviz" = {
        ...
        format =
          "<span color='#a6e3a1'>[</span> {} <span color='#a6e3a1'>]</span>";
      };
      ...
      "custom/weather" = {
        return-type = "json";
        exec =
          "sh -lc 'WEATHER_ICON_STYLE=emoji WEATHER_TOOLTIP_MARKUP=1 ~/.local/bin/weather'";
        interval = 600;
        tooltip = true;
      };
      ...
      network = {
        ...
        on-click =
          "kitty --class floatwlmenu -e bash ~/.config/scripts/wireless-menu.sh";
      ...
      "custom/swaync" = {
        ...
        on-click-right =
          "systemctl --user start swaync.service; swaync-client -d";
        escape = true;
      };
    ...
    style = ''
      * {
      ...
      #idle_inhibitor.activated {
        background-color: #a6e3a1; /* green when activated */
      }

      #idle_inhibitor.deactivated {
       /* background-color: #f38ba8; red when deactivated */
      }
