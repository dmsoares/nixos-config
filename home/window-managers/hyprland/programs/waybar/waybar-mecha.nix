    ...
    settings = {
      mainBar = {
        ...
        "custom/startmenu" = {
          ...
          "on-click-right" =
            "nwg-drawer -mr 225 -ml 225 -mt 200 -mb 200 -is 48 --spacing 15";
        };
        ...
        "custom/wifi" = {
          ...
          "on-click-right" =
            "kitty --title '󰤨 Network Manager TUI' bash -c nmtui";
          interval = 1;
          min-length = 1;
          max-length = 1;
        };
        ...
        mpris = {
          ...
          "status-icons" = {
            paused = "<span color='#b4befe'>u200Au200A󰏤u2009u2009</span>";
          };
        ...
        backlight = {
          ...
          tooltip = false;
          "on-scroll-up" =
            "~/.config/waybar/scripts/brightness-control.sh -o i";
          "on-scroll-down" =
            "~/.config/waybar/scripts/brightness-control.sh -o d";
          min-length = 6;
          max-length = 6;
        };
        ...
        "custom/power" = {
          ...
          tooltip = true;
          "tooltip-format" =
            "Power menu: Left-click for QS logout, Right-click for rofi power menu";
          "on-click" = "qs-wlogout";
